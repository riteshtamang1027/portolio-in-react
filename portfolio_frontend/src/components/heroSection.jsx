      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full xl:gap-16 gap-4 py-2 sm:px-4">
          ...
          <div className="md:w-2/3 space-y-8 md:order-1 order-2 max-md:text-center py-2 max-md:px-4">
            ...
            <div className="flex flex-col gap-6 2xl:flex-row max-md:items-center max-md:justify-center ">
              ...
              >
                <Link
                  to={"/resume"}
                  className="relative overflow-hidden px-5 py-2 rounded-full font-semibold text-[var(--tooltip-color)] bg-[var(--text-secondary)]/90 cursor-pointer border-transparent border transition-all duration-500 hover:scale-105 hover:text-[var(--text-hover)] hover:border-[var(--border-radious)] hover:bg-transparent"
                >
                ...
                <Link
                  to={"/contact"}
                  className="px-5 py-2 rounded-full font-semibold text-[var(--text-hover)] border border-[var(--border-radious)] hover:bg-[var(--text-secondary)]/90 hover:text-[var(--tooltip-color)] transition-all duration-500 whitespace-nowrap hover:scale-105"
                >
                  Contact Me
                </Link>
              </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
            className="w-full max-w-[280px] md:max-w-[320px] max-h-[280px] md:max-h-[320px] mx-auto rounded-full overflow-hidden border-1 border-[var(--border-radious)]/60 shadow-[var(---shadow-primary)] transition-all duration-500 cursor-pointer order-1 md:order-2"
          >
            <img
